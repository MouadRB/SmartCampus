...
class $AnnouncementsTableTable extends AnnouncementsTable
    with TableInfo<$AnnouncementsTableTable, AnnouncementTableData> {
  @override
...
class AnnouncementTableData extends DataClass
  ...
  AnnouncementTableData copyWithCompanion(AnnouncementsTableCompanion data) {
    return AnnouncementTableData(
...
class $$AnnouncementsTableTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
...
typedef $$AnnouncementsTableTableProcessedTableManager =
...
typedef $$TimetableTableTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        TimetableTableData,
        BaseReferences<_$AppDatabase, $TimetableTableTable, TimetableTableData>,
      ),
      TimetableTableData,
      PrefetchHooks Function()
    >;
